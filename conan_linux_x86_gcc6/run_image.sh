...
docker run --rm -it -d --name conan_linux_x86_gcc6 -v conan_linux_x86_gcc6_data:/home/conan/.conan/data $(main::GetProxyConfiguration) rogersantos/conan_linux_x86_gcc6 /bin/bash

echo "conan_linux_x86_gcc6"
