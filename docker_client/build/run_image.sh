...
main::image_name()
{
  # echo "rogersantos/docker_client_stage:windows"
  echo "rogersantos/docker_client:windows"
}
...
echo docker run $(main::GetContainerNameCommand) $(main::execution_config) $(main::debug_config) $(main::volume_config) $(main::image_name)
docker run $(main::GetContainerNameCommand) $(main::execution_config) $(main::debug_config) $(main::volume_config) $(main::image_name)
