...
docker run --rm -it -d --name conan_linux_x64_gcc7 -v conan_linux_x64_gcc7_data:/home/conan/.conan/data $(main::GetProxyConfiguration) rogersantos/conan_linux_x64_gcc7 /bin/bash

echo "conan_linux_x64_gcc7"
