...
docker build $(main::cache_command) -f ./conan_client_stage.docker $(main::GetProxyConfig) -t "rogersantos/conan_client_stage:windows" .
docker build $(main::cache_command) -f ./conan_client.docker $(main::GetProxyConfig) -t "rogersantos/conan_client:windows" .
